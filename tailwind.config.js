...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glow:    '0 0 20px rgba(63,255,33,.20), 0 0 40px rgba(63,255,33,.08)',
        'glow-sm': '0 0 10px rgba(63,255,33,.18)',
        card:    '0 4px 24px rgba(0,0,0,.35), 0 1px 2px rgba(0,0,0,.2)',
        'card-hover': '0 8px 32px rgba(0,0,0,.5), 0 0 0 1px rgba(63,255,33,.08)',
        modal:   '0 24px 80px rgba(0,0,0,.65), 0 0 1px rgba(63,255,33,.1)',
      },
      animation: {
